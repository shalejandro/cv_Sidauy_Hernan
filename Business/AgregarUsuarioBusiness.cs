...
namespace Business
{
    public class AgregarUsuarioBusiness
    {
        public void agregar(Interno usuarioNuevo)
        {
            ...
            string consulta = "insert into interno values (@dni,@legajo,@nombre,@apellido,@direccion,@codigo,@usuario,@clave,@puesto,@sexo,'" + Convert.ToDateTime( usuarioNuevo.Fnac) + "',@horario,@mail)";
            try
            {
                ...
                //conexion.agregarParametro("@fnac", usuarioNuevo.Fnac.ToShortDateString());
